...
object WikipediaRanking {
  ...
  val sc: SparkContext = new SparkContext(master = "local[*]", appName = "wikipedia", sparkConf)
  ...
  def occurrencesOfLang(lang: String, rdd: RDD[WikipediaArticle]): Int = {
    rdd.filter( (article) => (article.text.contains(lang) || article.title.contains(lang)) ).count().intValue() // arg is an article
  }
